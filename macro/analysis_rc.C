...
void analysis_rc(std::vector<std::string> arg_string1,std::vector<std::string> arg_string2,std::string out_name) {
	...
	title_name    .push_back("rc_muon_kcut_zmass"                   );
	...
	title_name    .push_back("rc_muon_kcut_zpt"                     );
	...
	title_name    .push_back("rc_muon_kcut_invis_costheta"          );
	...
	title_name    .push_back("rc_muon_kcut_recoil_mass"             );
	...
	title_name    .push_back("rc_muon_kcut_vis_e"                   );
	...
	title_name    .push_back("rc_muon_lep_pair_mass"                );
	...
	title_name    .push_back("rc_muon_lep_pair_costheta"            );
	...
	title_name    .push_back("rc_muon_lep_pair_costheta_pair"       );
	...
	title_name    .push_back("rc_muon_lep_pair_costheta_track1"     );
	...
	title_name    .push_back("rc_muon_lep_pair_costheta_track2"     );
	...
	//variables that do not want to plot
	//aux_0
	aux_iname     .push_back("rc_muon_num"				            );
	aux_iname     .push_back("rc_muon_num_plus"				        );
	aux_iname     .push_back("rc_muon_num_minus"				    );
	...
	for(unsigned int i=0;i<filename.size();i++){
		...
		for(int event=0;event<nevent[i];event++){
			...
			// add cuts
			if(!GetCut(aux_i[0]   ,    2,   100,pass_basic_muon[i])){continue;}
			if(!GetCut(aux_i[1]   ,    1,   100,pass_basic_muon[i])){continue;}
		...
		ShowMessage(3,"passed cut muon precut         ", pass_pre        [i]);
