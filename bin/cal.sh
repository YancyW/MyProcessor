...
out_name=${input_direction}/${input_class_name}.dat



if [[ $# == 2 ]] ; then
	cal_name=${input_direction}/${input_class_name}_${input_final_state}.dat
	if [[ -a ${cal_name} ]] ; then
	...
	cal_name=${input_direction}/${input_class_name}_${input_final_state}.dat
	cal_name2=${input_direction}/${input_class_name}_${input_final_state2}.dat
